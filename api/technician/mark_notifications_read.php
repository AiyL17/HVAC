...
try {
    ...
    // Mark all notifications as read for this technician
    $result = $notificationHandler->markTechnicianNotificationsAsRead($_SESSION['uid']);
    ...
    error_log("Error marking technician notifications as read: " . $e->getMessage());
